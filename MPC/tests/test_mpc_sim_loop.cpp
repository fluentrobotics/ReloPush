...
// Widened 0.015->0.02 (de-flake): unchanged-binary K=0 runs saw hold_max_|v| up to 0.0161; 0.02 still enforces genuine stationarity.
constexpr double kHoldDriftTol = 0.02;
constexpr double kHoldVTol = 0.02;
