...
struct PlanningDebugStats
{
    ...
    std::size_t analytic_boundary_collision = 0;
    std::size_t analytic_object_collision = 0;
    std::size_t analytic_robot_soft_collision = 0;
    std::size_t analytic_other_collision = 0;
    std::size_t analytic_post_arrival_collision = 0;
    std::size_t analytic_post_arrival_boundary_collision = 0;
    std::size_t analytic_post_arrival_object_collision = 0;
    std::size_t analytic_post_arrival_robot_soft_collision = 0;
    std::size_t analytic_post_arrival_other_collision = 0;
    ...
    std::size_t search_iteration_limit_hit = 0;
    std::size_t spatial_index_collapses = 0;
    std::size_t wait_primitives_skipped = 0;
    double best_dist = std::numeric_limits<double>::infinity();
    double best_yaw_error = std::numeric_limits<double>::infinity();
    Pose best_pose;
    int planner_expansion_threads = 1;
    double analytic_threshold = 0.0;
    double holonomic_heuristic_time_sec = 0.0;
